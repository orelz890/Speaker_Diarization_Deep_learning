...
#     # Incorporate the parsing of command line arguments. Instead of having to manually set variables inside of the code.
...
#             # uses Python’s unpickling facilities
#             model = torch.load(args.model_file)
#             # simply convert the initialized model
#             model = model.to(device)
#         elif args.model is not None and args.weights is not None:
#             # kind of switch for some specific layers / parts of the model that behave differently
...
#         # the main class used to run a model.
...
#                         # join makes a new path intelligently.
#                         # samplerate is the size of the read data
